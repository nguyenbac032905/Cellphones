...
const REGISTER_TOKEN_EXPIRES = process.env.REGISTER_TOKEN_EXPIRES! as SignOptions["expiresIn"];
...
export const generateRegisterToken = (payload: object) => {
    return jwt.sign(payload, REGISTER_SECRET, {
        expiresIn: REGISTER_TOKEN_EXPIRES,
    });
};