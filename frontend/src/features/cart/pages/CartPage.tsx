                            ...
                            <div className="flex items-center justify-between gap-3 sm:gap-4 relative py-3">
                                <div className="flex items-center gap-3 shrink-0">
                                    ...
                                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl border border-neutral-100 p-1 flex items-center justify-center shrink-0">
                                        <img
                                            ...
                                            src="https://cdn2.cellphones.com.vn/insecure/rs:fill:350:0/q:80/plain/https://cellphones.com.vn/media/catalog/product/m/a/may-rua-mat-halio-sensitive-facial-cleansing-massaging-device_2.png"
                                            alt="Máy rửa mặt Halio"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 flex flex-col gap-1.5 min-w-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm sm:text-base font-bold text-primary-500">408.000đ</span>
                                        <span className="text-xs text-neutral-400 line-through">830.000đ</span>
                                    </div>
                                </div>
