        ...
        <div className="md:flex gap-4">
            <div className="hidden flex-1 md:flex flex-col justify-between gap-3">
                <Link to={"/"} className="rounded-2xl overflow-hidden">
                    <img width={321} height={795} src="https://cdn2.cellphones.com.vn/insecure/rs:fill:321:795/q:100/plain/https://media-asset.cellphones.com.vn/page_configs/01KWE8EDQE54YXMHVKP0GA8HJD.png" />
                </Link>
                <Link to={"/"} className="rounded-2xl overflow-hidden">
                    <img width={321} height={795} src="https://cdn2.cellphones.com.vn/insecure/rs:fill:321:795/q:100/plain/https://media-asset.cellphones.com.vn/page_configs/01KWZQJZAX8D63YB392VZ0QNCJ.png" />
                </Link>
            </div>
