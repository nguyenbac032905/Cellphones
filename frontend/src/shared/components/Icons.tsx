...
export const UserOutlineIcon = () => {
    return <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 496 512" className="size-5" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
